...
The fish are numbered from 0 to N − 1. If P and Q are two fish and 
P < Q, then fish P is initially upstream of fish Q. Initially, each 
...
precisely, we say that two fish P and Q meet each other when 
